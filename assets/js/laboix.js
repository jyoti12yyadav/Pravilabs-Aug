(function ($) {
  ...
  // Date Picker
  if ($(".laboix-datepicker").length) {
    $(".laboix-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accrodion
  if ($(".laboix-accrodion").length) {
    var accrodionGrp = $(".laboix-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".laboix-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".laboix-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  function thmOwlInit() {
    // owl slider
    let laboixowlCarousel = $(".laboix-owl__carousel");
    ...
    let laboixowlCarouselNav = $(".laboix-owl__carousel--custom-nav");
  ...
  function laboix_stretch() {
    var i = $(window).width();
    $(".row .laboix-stretch-element-inside-column").each(function () {
      var $this = $(this),
